...
export function setLocalStorage (name, data) {
  localStorage.setItem(`${APP_NAME ? APP_NAME.toUpperCase() + ':' : ''}${name}`, getObjectType(data) !== 'String' ? JSON.stringify(data) : data)
}

export function getLocalStorage (name) {
  let storage = localStorage.getItem(`${APP_NAME ? APP_NAME.toUpperCase() + ':' : ''}${name}`)
  let result = storage
  try {
...
export function removeLocalStorage (name) {
  localStorage.removeItem(`${APP_NAME ? APP_NAME.toUpperCase() + ':' : ''}${name}`)
}

export function setSessionStorage (name, data) {
  sessionStorage.setItem(`${APP_NAME ? APP_NAME.toUpperCase() + ':' : ''}${name}`, getObjectType(data) !== 'String' ? JSON.stringify(data) : data)
}

export function getSessionStorage (name) {
  let storage = sessionStorage.getItem(`${APP_NAME ? APP_NAME.toUpperCase() + ':' : ''}${name}`)
  let result = storage
  try {
    result = JSON.parse(storage)
  } catch (e) {
...
export function removeSessionStorage (name) {
  sessionStorage.removeItem(`${APP_NAME ? APP_NAME.toUpperCase() + ':' : ''}${name}`)
}
